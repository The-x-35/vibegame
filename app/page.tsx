...
import { ArrowRight, Code, Sparkles, Zap, Gamepad2, Star, Users } from "lucide-react";
      ...
      <section className="py-20 md:py-28">
        <div className="container px-4 mx-auto">
          <div className="max-w-4xl mx-auto text-center mb-16">
            ...
            <div className="inline-block p-2 px-3 mb-8 rounded-full bg-blue-500/10 border border-blue-500/20">
