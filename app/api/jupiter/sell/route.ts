...
export async function POST(request: Request) {
  try {
    console.log('Starting Jupiter Pro API sell request...');
    
    const { amount, inputMint, wallet, signedTransaction } = await request.json();
    console.log('Request params:', { amount, inputMint, wallet, hasSignedTx: !!signedTransaction });
